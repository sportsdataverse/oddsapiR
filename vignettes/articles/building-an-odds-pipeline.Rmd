...
description: "Assembling a repeatable odds-collection pipeline with <code>oddsapiR</code> - scheduling pulls, storing line history, and tracking how a market moves toward close."
---
...
To cite the [**`oddsapiR`**](https://oddsapiR.sportsdataverse.org/) R package in publications, use:
